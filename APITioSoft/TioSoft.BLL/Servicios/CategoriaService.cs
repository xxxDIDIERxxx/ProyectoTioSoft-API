    ...
    public class CategoriaService : ICategoriaService
    {
        ...
        public async Task<bool> Editar(CategoriaDTO modelo)
        {
            try
            {
                ...
                // Verificar si existe otra categoria con el mismo nombre pero diferente ID
                var cetegoriaExistente = await _categoriaRepositorio.Obtener(u =>
                    u.Nombre == modelo.Nombre && u.IdCategoria != modelo.IdCategoria
                );

                if (cetegoriaExistente != null)
                {

    ...
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
            ...
            CreateMap<Producto, ProductoDTO>()
                ...
                .ForMember(destino =>
                    destino.Precio,
                    opt => opt.MapFrom(origen => origen.Precio.Value.ToString("N", new CultureInfo("es-CO")))
                )
                .ForMember(destino =>
                    destino.EsActivo,
                    opt => opt.MapFrom(origen => origen.EsActivo == true ? 1 : 0)
            ...
            CreateMap<Compra, CompraDTO>()
                .ForMember(destino =>
                    destino.TotalTexto,
                    opt => opt.MapFrom(origen => origen.Total.Value.ToString(new CultureInfo("es-CO")))
                )
                .ForMember(destino =>
            ...
            CreateMap<DetalleCompra, DetalleCompraDTO>()
                ...
                .ForMember(destino =>
                    destino.TotalTexto,
                    opt => opt.MapFrom(origen => origen.Total.Value.ToString("N", new CultureInfo("es-CO")))
                );
            ...
            CreateMap<Venta, VentaDTO>()
                .ForMember(destino =>
                    destino.TotalTexto,
                    opt => opt.MapFrom(origen => string.Format(new CultureInfo("es-CO"), "{0:N2}", origen.Total * 10))
                )
                .ForMember(destino =>
                    destino.FechaRegistro,
                    opt => opt.MapFrom(origen => origen.FechaRegistro.Value.ToString("dd/MM/yyyy"))
            ...
            CreateMap<VentaDTO, Venta>()
                .ForMember(destino =>
                    destino.Total,
                    opt => opt.MapFrom(origen => Convert.ToDecimal(origen.TotalTexto.Replace(".", ""), new CultureInfo("es-CO")))
                );
            #endregion Venta
